...
To leave use the mouse to click the Parsec icon in the top-left hand corner of your screen, or press CTRL-SHIFT-M and use the arrow keys to select disconnect.
